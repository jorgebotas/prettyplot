...
def get_hatch_patterns(mode: Optional[int] = None) -> List[str]:
    ...
    # Calculate multiplier: mode 1 = 3x, mode 2 = 6x, mode 3 = 9x
    multiplier = mode * 3

    # Generate patterns by multiplying base patterns
    return [_generate_denser_pattern(pattern, multiplier) for pattern in BASE_HATCH_PATTERNS]
...
def set_hatch_mode(mode: Optional[int] = None) -> None:
    ...
    explicitly overridden. The mode determines the density of hatch patterns:
        ...
        - Mode 1: base × 3 patterns (e.g., '///', '...') - recommended
        - Mode 2: base × 6 patterns (e.g., '//////', '......') - medium density
        - Mode 3: base × 9 patterns (e.g., '/////////', '.........') - dense
    ...
    if mode not in [1, 2, 3]:
        raise ValueError(
            ...
            "2 (medium), or 3 (dense), or None to reset to default."
        )
